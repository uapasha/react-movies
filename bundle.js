...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MoviesBox = __webpack_require__(161);

	var _MoviesBox2 = _interopRequireDefault(_MoviesBox);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	(0, _reactDom.render)(_react2.default.createElement(_MoviesBox2.default, { url: 'http://localhost:3000/api/v1/movies/page/',
	                  submitUrl: 'http://localhost:3000/api/v1/movies/',
	                  deleteUrl: 'http://localhost:3000/api/v1/movies/delete/' }), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MovieForm = __webpack_require__(162);

	var _MovieForm2 = _interopRequireDefault(_MovieForm);

	var _MoviesList = __webpack_require__(163);
	...
	var MoviesBox = function (_React$Component) {
	    _inherits(MoviesBox, _React$Component);

	    function MoviesBox(props) {
	        _classCallCheck(this, MoviesBox);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MoviesBox).call(this, props));
	    ...
	    _createClass(MoviesBox, [{
	        ...
	        value: function fetchData() {
	            ...
	            fetch(url).then(function (response) {
	                ...
	                var allMovies = _this2.state.data.concat(responseData.movies);
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_MoviesList2.default, { data: this.state.data.movies ? this.state.data.movies : this.state.data,
	                    deleteUrl: this.props.deleteUrl }),
	                _react2.default.createElement(_MovieForm2.default, { onMovieSubmit: this.handleMovieSubmit.bind(this) }),
	                this.state.noMoreMovies ? _react2.default.createElement(
	                    'p',
	                    { className: 'message' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MovieForm = function (_React$Component) {
	    ...
	    function MovieForm(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MovieForm).call(this, props));
	        ...
	        _this.handleStarChange = _this.handleStarChange.bind(_this);
	        _this.handleSubmit = _this.handleSubmit.bind(_this);
	        _this.addStar = _this.addStar.bind(_this);
	        return _this;
	    }

	    _createClass(MovieForm, [{
	        key: 'addStar',
	        value: function addStar(e) {
	            e.preventDefault();
	            var newStars = this.state.stars.concat(this.state.newStar.trim());
	            this.setState({
	                stars: newStars,
	                newStar: ''
	            });
	        ...
	        value: function handleStarChange(e) {
	            this.setState({
	        ...
	        value: function handleSubmit(e) {
	            ...
	            var movie = { title: title, year: year, format: format, stars: stars };
	        ...
	        key: 'renderAddStars',
	        value: function renderAddStars() {
	            var numForKey = 0;
	            return _react2.default.createElement(
	                'div',
	                { className: 'newMovieStars' },
	                this.state.stars.length === 0 ? _react2.default.createElement(
	                    'p',
	                    { className: 'message' },
	                    'No stars added'
	                ) : _react2.default.createElement(
	                ...
	                this.state.stars.map(function (star) {
	                    ...
	                    return _react2.default.createElement(
	                        'div',
	                        { key: "star_" + numForKey, className: 'newStar' },
	                        _react2.default.createElement(
	                            'p',
	                            null,
	                            star
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'form',
	                { className: 'movieForm', onSubmit: this.handleSubmit },
	                ...
	                _react2.default.createElement('input', { type: 'text', placeholder: 'Enter movie format',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Movie = __webpack_require__(164);
	...
	var MoviesList = function (_React$Component) {
	    ...
	    function MoviesList(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MoviesList).call(this, props));
	        ...
	        _this.handleSortByChange = _this.handleSortByChange.bind(_this);
	        _this.handleSortDirectionMethods = _this.handleSortDirectionMethods.bind(_this);
	        return _this;
	    }
	    ...
	    _createClass(MoviesList, [{
	        ...
	        value: function handleSortByChange(e) {
	        ...
	        key: 'handleSortDirectionMethods',
	        value: function handleSortDirectionMethods(e) {
	            this.setState({
	        ...
	        key: 'sort',
	        value: function sort(nextProps, sortBy) {
	            var sortAsc, sortDesc;
	            var sortCriterium = this.state.sortBy;
	        ...
	        value: function renderMovies() {
	            ...
	            return this.state.data.map(function (movie) {
	                return _react2.default.createElement(_Movie2.default, { movie: movie, key: movie._id, deleteUrl: _this2.props.deleteUrl });
	            });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'select',
	                    { name: 'changeSortBy', onChange: this.handleSortByChange, value: this.state.sortBy },
	                    this.state.sortByMethods.map(function (method) {
	                        return _react2.default.createElement(
	                            'option',
	                            { key: "select" + method, value: method },
	                ...
	                _react2.default.createElement(
	                    'select',
	                    { name: 'changeSortBy', onChange: this.handleSortDirectionMethods,
	                        value: this.state.sortDirection },
	                    this.state.sortDirectionMethods.map(function (method) {
	                        return _react2.default.createElement(
	                            'option',
	                            { key: "select" + method, value: method },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Movie = function (_React$Component) {
	    ...
	    function Movie(props) {
	        ...
	        _this.handleMovieRemove = _this.handleMovieRemove.bind(_this);
	        return _this;
	    }

	    _createClass(Movie, [{
	        key: 'handleMovieRemove',
	        value: function handleMovieRemove() {
	            $.ajax({
	                ...
	                var _ret = function () {
	                    ...
	                    return {
	                        v: _react2.default.createElement(
	                            'ul',
	                            { className: 'movieStars' },
	                            _react2.default.createElement(
	                                'h2',
	                                null,
	                                'Stars:'
	                            ),
	                            _this2.props.movie.stars.map(function (star) {
	                                numForKey += 1;
	                                return _react2.default.createElement(
	                                    'li',
	                                    { key: star + "_" + numForKey },
	                                    star
	                                );
	                            })
	                        )
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'strong',
	                        null,
	                        this.props.movie.year ? this.props.movie.year : _react2.default.createElement(
	                            'strong',
	                            { className: 'message' },
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'strong',
	                        null,
	                        this.props.movie.format ? this.props.movie.format : _react2.default.createElement(
	                            'strong',
	                            { className: 'message' },
	                            'No format provided'
	                        )
	                ...
	                _react2.default.createElement(
	                    'button',
	                    { onClick: this.handleMovieRemove },
	                    'Remove movie'
	                )
	            );
	        }
	...
	var FileUpload = function (_React$Component) {
	    ...
	    _createClass(FileUpload, [{
	        ...
	        value: function uploadFile(e) {
	            e.preventDefault();
	            console.log(_reactDom2.default.findDOMNode(this.refs.file));
	            var fd = new FormData();
	            fd.append('moviesFile', _reactDom2.default.findDOMNode(this.refs.file).files[0]);
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement('input', { ref: 'file', type: 'file', name: 'moviesFile', className: 'upload-file' }),
	                    _react2.default.createElement('input', { type: 'submit', value: 'Upload File', name: 'submit' })
	                )
	            );
	        }
	    }]);
